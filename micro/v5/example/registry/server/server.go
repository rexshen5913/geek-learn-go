...
import (
	"fmt"
	"gitee.com/geektime-geekbang/geektime-go/micro/v5"
	"gitee.com/geektime-geekbang/geektime-go/micro/v5/example/proto/gen"
	"gitee.com/geektime-geekbang/geektime-go/micro/v5/registry/etcd"
