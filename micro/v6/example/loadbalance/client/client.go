...
import (
	"encoding/json"
	"fmt"
	"gitee.com/geektime-geekbang/geektime-go/micro/v6/example/proto/gen"
	"gitee.com/geektime-geekbang/geektime-go/micro/v6/loadbalance/roundrobin"
	"gitee.com/geektime-geekbang/geektime-go/micro/v6/registry/etcd"
